...
Ten fields iare used to record (capture) an Event:
...
Event | Lookup | [Event value](#event-lookup) | Describes a document, occurence , or incident.  Typically has associated documentation
Action | Lookup | [Action value](#action-lookup) | A verb identifying the occurence being recorded.  Typically expressed in terms of the Event argument
